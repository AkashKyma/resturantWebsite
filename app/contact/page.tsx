...
export default function ContactPage() {
  return (
    <main className="section-shell space-y-10">
      <SectionIntro
        eyebrow="Contact"
        title="Everything needed to find us, call us, or plan a proper Chinese dinner."
        description="The essentials live here: address, phone, email, and opening hours for dine-in, pickup, tea service, and group reservations."
      />
      ...
      <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="card-surface p-8">
          ...
          <div className="mt-8 rounded-3xl bg-slate-950 p-6 text-white">
            <h3 className="text-2xl font-bold">Planning a banquet or large family table?</h3>
            <p className="mt-3 leading-7 text-slate-300">
              Email the team with your party size and preferred date. We&apos;ll help with banquet menus, tea service, and pacing for shared dishes.
            </p>
          </div>
        </div>
      </section>
